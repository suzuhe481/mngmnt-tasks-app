  ...
  return (
    <div className="relative flex flex-row justify-center py-4 bg-slate-700">
      <button
        ...
        className="animate-all absolute left-2 text-white cursor-pointer border-1 border-white p-2 rounded-md text-[0.6rem] lg:text-base top-1/2 -translate-y-1/2 hover:bg-slate-300 hover:text-slate-800"
      >
